...
{{--                    </li>--}}
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Designed &amp; Develop <i class="fa fa-user" aria-hidden="true"></i> by <a href="https://ayushtimalsina.com.np/" target="_blank">Aayush Timalsina</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
