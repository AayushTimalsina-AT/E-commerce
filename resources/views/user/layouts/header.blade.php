        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                <div class="left-top-bar">
                    First time in Nepal, Available all over Nepal.
                </div>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li class="{{'home' == request()->path() ? 'current' : ''}}">
                            <a href="{{route('home')}}">Home</a>
                        </li>

                        <li class="label1 {{'shop' == request()->path() ? 'current' : ''}} " data-label1="hot" >
                            <a href="{{route('shop')}}">Shop</a>
                        </li>

                        <li class="{{'wishlist' == request()->path() ? 'current' : ''}}" >
                            <a href="{{route('wishlist')}}">wishlist</a>
                        </li>

                        <li class="{{'cart' == request()->path() ? 'current' : ''}}">
                            <a href="{{route('cart')}}">cart</a>
                        </li>

                        <li class="{{'about' == request()->path() ? 'current' : ''}}">
                            <a href="{{route('about')}}">About</a>
                        </li>

                        <li class="{{'contact' == request()->path() ? 'current' : ''}}">
